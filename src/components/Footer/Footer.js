        ...
        <>
            ...
            <div className='flex flex-col md:flex-row  w-screen md:w-[950px]  mx-auto h-auto md:h-[100px] pt-4 bg-green-900 md:bg-gray-900 pb-8 md:pb-0'>
                ...
                <div className="buttons md:w-[500px] pt-3 md:mt-3 flex justify-center items-center bg-green-900 md:bg-gray-900">
                    <div className="md:rounded-full rounded-2xl w-auto mx-1 md:w-[380px] md:bg-gray-800 h-[45px] md:h-[55px] flex md:flex-row   items-center shadow-inner border-1 border-black shadow-black bg-white">
                        <input type="text" placeholder='Enter Your Email' className='md:bg-gray-800 ml-2 bg-white' />
                        <span className=' w-20 mr-2 md:h-8 shadow-lg hover:shadow-white hover:border  hover:border-blue-900 cursor-pointer shadow-black md:bg-gray-900 bg-gray-900 text-white rounded-full ml-2 md:ml-16 flex justify-center items-center '>Join us</span>
                    </div>
                </div>
            ...
            <div className='flex flex-row justify-between w-screen md:w-[950px] md:mx-auto  md:h-[100px] mt-4 md:mt-8 pb-8 md:mb-0 '>
                <div className="flex flex-col md:w-[450px] ">
            ...
            <div className="w-screen md:w-[1000px] mx-auto  m:h-[300px] flex flex-col md:flex-row md:items-center ">
                <div className="address md:w-[340px] pt-8  md:pt-16 pl-8 flex md:flex-col">
                    ...
                    <div className="buttons w-screen md:w-[500px] flex flex-col space-y-6 justify-center items-center md:hidden ">
                        <div className="custom h-12 shadow-md md:shadow-lg w-32 hover:border-green-500  shadow-blue-400 border  justify-center space-x-2 flex hover:space-x-4 ml-8 items-center  rounded-full px-3 border-blue-500">
