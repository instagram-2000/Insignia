        ...
        <div className="flex flex-col  md:flex-row  static">
          <div className=" shadow-2xl hover:shadow-red-900  shadow-black rounded-3xl bg-black md:w-[500px] md:h-[230px] mt-6 md:mt-12 md:ml-16 flex flex-row pt-8 mr-8">
            ...
            <div className="flex flex-col ">
              <span className="text-blue-300 text-xl font-bold mx-8">
                John Fang
              </span>
              <div className="flex flex-row items-center">
                <span className="text-blue-500 text-xs font-bold mx-8 ">
                  Web developer
                </span>
                <div className="flex flex-row space-x-1 animate-pulse">
                  <img
                    src={dot}
                    alt="Image here"
                    className="md:h-4 md:w-4 h-2 w-2 rounded-full"
                  ></img>
                  <img
                    src={dot}
                    alt="Image here"
              ...
              <span className="text-white text-sm md:ml-8 md:mr-16 mb-4 md:mb-0 mr-4  mt-8">
                Suspendise ultrices at diam lectus nullam. nisl, sagitlis
                vieverra enim erat lartor ultrices massa turpis. Arcu Pulvinar
