        ...
        <div className="flex md:flex-row  overflow-auto space-x-8 md:space-x-16 w-[550px] md:w-auto ">
          <div className=" shadow-xl   rounded-3xl hover:shadow-red-900  bg-black w-[170px]  md:w-[300px] md:h-[450px] mt-16 md:ml-16 flex flex-col pt-8 ">
            ...
            <div className="flex flex-col  ">
              <span className="text-blue-300 text-md mx-auto md:text-xl  md:mx-8">
                Search Data
              </span>
              <span className="text-white text-xs mx-3 md:mx-8 md:mt-8 mt-2 ">
                Dont worry if your data is very large , insignia provides a
                search engine, which is useful for making it easier to find data
                effectivery saving time.
              </span>
              <span className="text-white text-sm mx-2 ml-4 md:ml-8 flex flex-row items-center mt-3 justify-center md:mt-12">
                {" "}
                Learn more
                <div className="item-2 text-blue-800 text-2xl ml-2">&rarr;</div>
              </span>
            </div>
          </div>
          ...
          <div className=" shadow-xl   rounded-3xl hover:shadow-red-900  bg-black w-[170px]  md:w-[300px] md:h-[450px] mt-16 md:ml-16 flex flex-col pt-8 ">
            ...
            <div className="flex flex-col justify-between">
              <span className="text-blue-300 text-md  md:text-xl mx-auto md:mx-8">
                Print out
              </span>
              <span className="text-white text-xs mx-3 md:mx-8 md:mt-8 mt-2 ">
                Print out serviece gives you convienience if somebody you need
                print data , just edit it all and just print it.
              </span>
              <span className="text-white text-sm mx-2 ml-4 md:ml-8 flex flex-row items-center mt-10 justify-center md:mt-12">
                {" "}
                Learn more
                <div className="item-2 text-blue-800 text-2xl ml-2">&rarr;</div>
              </span>
          ...
          <div className=" shadow-xl md:absolute md:right-0   rounded-3xl hover:shadow-red-900  bg-black w-[170px]  md:w-[300px] md:h-[450px] mt-16 md:ml-16 flex flex-col pt-8 ">
            ...
            <div className="flex flex-col ">
              <span className="text-blue-300 text-md  md:text-xl mx-6 md:mx-8">
                Security Code
              </span>
              <span className="text-white text-xs mx-2 md:mx-8 md:mt-8 mt-2 ">
                Data security is one of out best facilites. Allows for you file
                to be safer . The file can be secured with a code or password
                that you created , so only you can open the file.
              </span>
              <span className="text-white text-sm mx-2 ml-4 md:ml-8 flex flex-row items-center mt-3 md:mt-12">
                {" "}
                Learn more
                <div className="item-2 text-blue-800 text-2xl ml-2">&rarr;</div>
              </span>
