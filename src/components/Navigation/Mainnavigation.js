    ...
    return (
        <div className='md:w-[1200px] w-auto h-[45px] px-2 md:px-0 flex justify-between  items-center mx-auto text-white '>
            ...
            <div className='flex items-center space-x-2 justify-center '>
                <div className="md:flex flex  justify-center left-0  items-center md:space-x-4  fixed md:static md:mr-8 md:w-auto w-screen bottom-0   md:bg-none h-auto bg-blue-500 md:bg-gray-900 rounded-t-2xl">
